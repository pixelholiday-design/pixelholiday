...
export const metadata: Metadata = {
  title: "Blog | Fotiqo",
  description: "Stories, tips, and holiday memories from the Fotiqo photography team.",
};
    ...
    <main className="min-h-screen bg-cream-50">
      <section className="max-w-4xl mx-auto px-6 py-16">
        <header className="mb-12 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-brand-600 mb-2">Fotiqo Journal</p>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-xs text-navy-400">
                      <span>{post.author?.name || "Fotiqo Team"}</span>
                      <span>{date}</span>
                    </div>
                  </div>
                </Link>
