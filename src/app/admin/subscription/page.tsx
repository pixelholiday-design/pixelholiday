...
const MOCK_BILLING: { date: string; amount: string; status: string; description: string }[] = [
  { date: "2026-03-01", amount: "€49.00", status: "Paid", description: "PixelHoliday Pro — March 2026" },
  { date: "2026-02-01", amount: "€49.00", status: "Paid", description: "PixelHoliday Pro — February 2026" },
  { date: "2026-01-01", amount: "€49.00", status: "Paid", description: "PixelHoliday Pro — January 2026" },
];
  ...
  return (
    <div className="space-y-10">
      <header>
        ...
        <p className="text-navy-400 mt-1">Manage your PixelHoliday plan, billing, and usage.</p>
      </header>
