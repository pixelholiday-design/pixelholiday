...
export const metadata = {
  title: "PixelHoliday — Install apps",
  description:
    "Install the PixelHoliday kiosk, gallery, photographer, camera station, and TV display apps on any device.",
};
...
const APPS: AppEntry[] = [
  ...
  },
  {
    ...
    steps: [
      "Sign in to the PixelHoliday app on your phone.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Clone the PixelHoliday camera client (see /admin/cameras).",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {APPS.map((app) => {
            ...
            const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(
              `https://pixelholiday.app${app.url}`,
            )}`;
            return (
              <article
                key={app.slug}
