...
export default function Page() {
  return <ProductPage icon={<Smartphone className="h-4 w-4" />} badge="Mobile Gallery" headline="Your brand, in your client&apos;s pocket" subheadline="Clients add your gallery to their home screen as a branded app. Offline viewing, push notifications, and instant access \ — no app store required." color="from-blue-500 to-blue-400" features={[
