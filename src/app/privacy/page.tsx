...
export const metadata = { title: "Privacy Policy — PixelHoliday" };
    ...
    <div className="min-h-screen bg-cream-100">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 prose prose-stone">
        ...
        <p className="text-navy-700">
          ...
          <a className="text-coral-600 mx-1" href="mailto:privacy@pixelholiday.com">privacy@pixelholiday.com</a>
        ...
        <p className="text-navy-700">
          Data Protection Officer · <a className="text-coral-600" href="mailto:dpo@pixelholiday.com">dpo@pixelholiday.com</a>
        </p>
