...
function aiGenerate(topic: string, photoIds: string[]) {
  const intro = `Discover the magic of ${topic} through the lens of Fotiqo photographers.`;
  const body = [
  ...
  const seoKeywords = [topic, "resort photography", "holiday memories", "fotiqo", "travel"];
