...
export default function WebsiteBuilderClient({ profile: initial, galleries, user }: Props) {
  ...
  const [form, setForm] = useState<Profile>({
    ...
    primaryColor: initial?.primaryColor || "#29ABE2",
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-slate-400">pixelvo.com/p/</span>
        ...
        {tab === "seo" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
              ...
              <p className="text-sm text-slate-500">Point a CNAME record to <code className="bg-slate-100 px-1 rounded text-xs">sites.pixelvo.com</code></p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="bg-slate-100 p-3 border-b border-slate-200 flex items-center gap-2">
              ...
              <div className="flex-1 bg-white rounded px-3 py-1 text-xs text-slate-400 text-center">
                pixelvo.com/p/{form.username || "your-name"}
              </div>
            </div>
            {form.username ? (
