...
export const metadata = {
  title: "Fotiqo — Portfolio",
  description:
    "Fotiqo captures unforgettable moments at the world's best resorts, water parks, and attractions. Browse our work and book your session today.",
  openGraph: {
    title: "Fotiqo — Portfolio",
